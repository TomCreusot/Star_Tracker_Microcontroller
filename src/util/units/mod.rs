...
/// println!("{:?}", angle);                             // Prints in long form "1.2345".
///
/// assert_eq!(Hours(12.345).time_format(), "12h 20m 42.00s"); // Prints in equatorial ra form.
/// ```
#[derive(Debug, Copy, Clone, PartialOrd)]//, PartialEq)]
...
///   
/// This coordinate system is an essential part of the [quest algorithm](crate::attitude_determination::Quest).  
