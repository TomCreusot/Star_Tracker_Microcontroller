/// Implementation for [StarDatabaseElement](crate::tracking_mode::database::StarDatabaseElement)
...
impl StarDatabaseElement
{
	...
	/// # Example
	/// ```
	/// use star_tracker_lib::tracking_mode::database::StarDatabaseElement;
