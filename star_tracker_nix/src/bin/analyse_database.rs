...
use star_tracker_lib::tracking_mode::database::array_database::K_VECTOR_DATABASE;
use star_tracker_lib::tracking_mode::database::array_database::STAR_PAIR_DATABASE;
use star_tracker_lib::tracking_mode::database::array_database::CATALOGUE_DATABASE;
