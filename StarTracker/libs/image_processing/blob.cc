...
void Blob::findBlobs ( Image& img, byte threshold, ArrayList<Blob>& list )
{
...
decimal Blob::getOriginX	( )	{	return origin.x;	}
decimal Blob::getOriginY	( )	{	return origin.y;	}


void 	Blob::spreadGrassFire ( Image& img, uint intense )
{
